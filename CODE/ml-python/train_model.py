...
def train():
    ...
    X = df[['circuit_name', 'compound', 'air_temp', 'track_temp', 'humidity', 'raining', 'wind_speed', 'pressure', 'avg_stint_length', 'total_laps', 'total_time', 'weather_condition', 'tire_wear_rate']]
    ...
    pipeline = Pipeline(steps=[
        ...
        ('regressor', RandomForestRegressor(n_estimators=100, random_state=8))
    ])
